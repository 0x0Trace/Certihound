    ...
    def generate_enterpriseca_node(
        ...
        return {
            ...
            "Properties": {
                ...
                "flags": ca.flags if ca.flags is not None else "Unknown",
                "isuserspecifiessanenabled": ca.is_user_specifies_san_enabled,
                "isuserspecifiessanenabledcollected": True,
                "issecurityextensiondisabled": ca.is_security_extension_disabled,
                "casecuritycollected": bool(ca.security_descriptor_raw),
                "enrollmentagentrestrictionscollected": True,
